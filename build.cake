...
Task("__Publish")
    ...
    .Does(() =>
{
    NuGetPush($"{artifactsDir}/Octopus.Server.Extensibility.Authentication.UsernamePassword.{nugetVersion}.nupkg", new NuGetPushSettings {
    ...
    {
        NuGetPush($"{artifactsDir}/Octopus.Server.Extensibility.Authentication.UsernamePassword.nupkg", new NuGetPushSettings {
